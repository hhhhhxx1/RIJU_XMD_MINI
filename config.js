...
ALIVE_MSG: process.env.ALIVE_MSG || "HEY DEAR, I'm RIJU to announce that ʀɪᴊᴜ xᴍᴅ is ALIVE now—ready to dive into new adventures with you!",
SUDO_NB: process.env.SUDO_NB || "919332446037",
